...
var setup = function setup(props) {
  return (0, _componentSetup["default"])(_play["default"], _objectSpread({
    children: 'play',
...
describe('Play', function () {
  it('has play class', function () {
    var _setup = setup(),
        wrapper = _setup.wrapper;

    (0, _expect["default"])(wrapper.hasClass(_constants.classes.PLAY)).toBe(true);
  });
  it('plays media on click', function () {
    var _setup2 = setup(),
        wrapper = _setup2.wrapper,
        props = _setup2.props;

    wrapper.simulate('click');
    (0, _expect["default"])(props.play).toHaveBeenCalledWith(id, props.paused);
  });
